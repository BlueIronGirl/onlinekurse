...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		URI newBeneficiaryUrl = restTemplate.postForLocation(addURL, "David", 1);
		assertNotNull(newBeneficiaryUrl);
		
		// TODO-14: Retrieve the Beneficiary you just created from the location that was returned
		Beneficiary newBeneficiary = restTemplate.getForObject(newBeneficiaryUrl, Beneficiary.class); // Modify this line to use the restTemplate
		
		assertNotNull(newBeneficiary);
		assertEquals("David", newBeneficiary.getName());
		
		// TODO-15: Delete the newly created Beneficiary
		restTemplate.delete(newBeneficiaryUrl);
		...
		HttpClientErrorException httpClientErrorException = assertThrows(HttpClientErrorException.class, () -> {
			...
			//   was not successful.
			restTemplate.getForObject(newBeneficiaryUrl, Beneficiary.class);
	...
	public void createSameAccountTwiceResultsin409() {
		Account account = new Account("12345678", "John Doe");
		account.addBeneficiary("Jane Doe");
