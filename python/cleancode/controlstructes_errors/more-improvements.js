...
function getTransactionProcessors(transaction) {
  ...
  } else if (usesTransactionMethod(transaction, TYPE_PAYPAL)) {
...
function isOpen(transaction) {
  return transaction.status === TRANSACTION_STATUS_OPEN;
}

function isPayment(transaction) {
  return transaction.type === TRANSACTION_TYPE_PAYMENT;
}

function isRefund(transaction) {
  return transaction.type === TRANSACTION_TYPE_REFUND;
}
